...
classical_model = fac.entanglement_model_factory(5,1,1,["classical"])
hybrid_model1 = fac.entanglement_model_factory(5,4,3,["circularx"]*3)
hybrid_model2 = fac.entanglement_model_factory(5,4,3,["none"]*3)
